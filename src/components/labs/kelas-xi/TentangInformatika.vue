<template>
  <div class="lab-container">
    <div class="lab-header">
      ...
      <p>Membahas gambaran umum kurikulum Informatika kelas XI dan pilar pengetahuan informatika.</p>
    </div>
    <div class="lab-workspace">
      <div class="placeholder-content">
        <h3>Materi Sedang Disusun</h3>
        <p>Halaman ini disiapkan untuk menampung modul materi Tentang Informatika.</p>
      </div>
    </div>
  </div>
</template>
